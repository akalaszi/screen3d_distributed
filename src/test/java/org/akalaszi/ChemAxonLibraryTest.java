...
public class ChemAxonLibraryTest {
	...
	private void readMol(String fileName) throws IOException,
			MolFormatException {
		InputStream is = ChemAxonLibraryTest.class
	...
	public void shouldAlignTwoMolecules() throws MolFormatException, AlignmentException {
		Molecule m = 
		MMPAlignment.preprocess(MolImporter.importMol("CCCCCC"),true);
		
		Molecule mo = 
		MMPAlignment.preprocess(MolImporter.importMol("CCCOCCC"),true);
